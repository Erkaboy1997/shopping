    ...
    <div class="card-body">
        <form action="{{route('admin.news.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-12 mb-1">
                    <fieldset class="form-group">
                        ...
                        <input type="text" name="source" class="form-control" id="basicInput" placeholder="">
                    </fieldset>
                </div>
            ...
            <fieldset class="form-group">
                ...
                <textarea class="ckeditor form-control" name="description_long"></textarea>
            </fieldset>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4 col-12 mb-1">
                    <fieldset class="form-group">
                        ...
                        <input type="text" name="category" class="form-control" id="basicInput" placeholder="">
                    </fieldset>
                </div>
